...
namespace FoW
{
    class FogOfWarLegacyManager : FogOfWarPostProcessManager
    {
        ...
        {
            _material = new Material(Shader.Find("Hidden/FogOfWarLegacy"));
    ...
    public class FogOfWarLegacy : MonoBehaviour
    {
        ...
        Camera _clearFogCamera = null;
        Material _clearFogMaterial = null;
        ...
        void OnDisable()
        {
            if (_clearFogCamera != null)
                Destroy(_clearFogCamera.gameObject);
            if (_clearFogMaterial != null)
                Destroy(_clearFogMaterial);
        }
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            _postProcess.clearFog = clearFog;
            _postProcess.clearFogMask = clearFogMask;
            _postProcess.Render();
        }
    }
}
