...
namespace FoW
{
    ...
    class FogOfWarPPSv2Manager : FogOfWarPostProcessManager
    {
        ...
        {
            _context = context;
            _sheet = _context.propertySheets.Get(Shader.Find("Hidden/FogOfWarPPSv2"));
        }
    ...
    [System.Serializable]
    [PostProcess(typeof(FogOfWarPPSv2Renderer), PostProcessEvent.AfterStack, "FogOfWar")]
    public sealed class FogOfWarPPSv2 : PostProcessEffectSettings
    {
        ...
        public LayerMaskParameter clearFogMask = new LayerMaskParameter { value = -1 };
    ...
    public sealed class FogOfWarPPSv2Renderer : PostProcessEffectRenderer<FogOfWarPPSv2>
    {
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            _postProcess.clearFog = settings.clearFog.value;
            _postProcess.clearFogMask = settings.clearFogMask.value;
            _postProcess.Render();
        }
    }
}
